...
class ResPartner(models.Model):
	...
	x_title = fields.Char('Title (DIANe)')
	...
	c_name = fields.Char('Company Name (DIANe)')
	c_nace = fields.Many2one('diane.nace', 'NACE Code L0', ondelete='restrict')
	c_nace1 = fields.Many2one('diane.nace', 'NACE Code L1', ondelete='restrict')
	c_nace2 = fields.Many2one('diane.nace', 'NACE Code L2', ondelete='restrict')
	c_nace3 = fields.Many2one('diane.nace', 'NACE Code L3', ondelete='restrict')
	c_nace4 = fields.Many2one('diane.nace', 'NACE Code L4', ondelete='restrict')
